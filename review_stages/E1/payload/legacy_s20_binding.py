...
def validate_legacy_s20_binding(project_root: Path, prior_review: Path, manifest: Path) -> str:
    ...
    integrity = project_root / "approvals" / "owner_n2b2_s20_artifact_integrity_remediation_receipt.yaml"
    ...
    _artifact_integrity_gate(integrity, reviewed_commit=historical_commit,
