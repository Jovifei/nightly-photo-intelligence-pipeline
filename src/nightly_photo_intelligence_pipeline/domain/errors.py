...
NPI_PROMOTION_REPARSE_POINT_REJECTED = "NPI_PROMOTION_REPARSE_POINT_REJECTED"
NPI_PROMOTION_BOUND_ROOT_IDENTITY_CHANGED = "NPI_PROMOTION_BOUND_ROOT_IDENTITY_CHANGED"
NPI_PROMOTION_PATH_ESCAPED_BOUND_ROOT = "NPI_PROMOTION_PATH_ESCAPED_BOUND_ROOT"
NPI_PROMOTION_VOLUME_IDENTITY_CHANGED = "NPI_PROMOTION_VOLUME_IDENTITY_CHANGED"
NPI_PROMOTION_RACE_DETECTED = "NPI_PROMOTION_RACE_DETECTED"
NPI_PROMOTION_RACE_RESISTANT_PATH_OPERATION_UNAVAILABLE = (
    "NPI_PROMOTION_RACE_RESISTANT_PATH_OPERATION_UNAVAILABLE"
)
...
NPI_SECURITY_BOUNDARY = "NPI_SECURITY_BOUNDARY"
...
class PromotionPathSafetyError(NpiError):
    """A handle-bound N2B1P path operation failed its security boundary."""

    error_code = NPI_PROMOTION_RACE_DETECTED
    exit_code = ExitCode.SECURITY_BOUNDARY
...
ERROR_CODE_TO_EXIT: dict[str, ExitCode] = {
    ...
    NPI_PROMOTION_REPARSE_POINT_REJECTED: ExitCode.SECURITY_BOUNDARY,
    NPI_PROMOTION_BOUND_ROOT_IDENTITY_CHANGED: ExitCode.SECURITY_BOUNDARY,
    NPI_PROMOTION_PATH_ESCAPED_BOUND_ROOT: ExitCode.SECURITY_BOUNDARY,
    NPI_PROMOTION_VOLUME_IDENTITY_CHANGED: ExitCode.SECURITY_BOUNDARY,
    NPI_PROMOTION_RACE_DETECTED: ExitCode.SECURITY_BOUNDARY,
    NPI_PROMOTION_RACE_RESISTANT_PATH_OPERATION_UNAVAILABLE: ExitCode.PREFLIGHT_UNSATISFIED,
    ...
    NPI_SECURITY_BOUNDARY: ExitCode.SECURITY_BOUNDARY,
